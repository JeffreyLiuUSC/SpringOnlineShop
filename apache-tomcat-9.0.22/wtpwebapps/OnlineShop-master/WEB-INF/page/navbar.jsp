    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <%-- <li><a href=" <c:url value="/aboutus" />">Official USC Bookstore</a></li> --%>
				<li><a href="https://www.uscbookstore.com">Official USC Bookstore</a></li>
        ...
        <p align=right>
			<font color = "#989E9E">
    			This is a personal project demonstration, all images and sources by courtesy of USC Bookstore.
   		 	</font>
		</p>
    </div>
</nav>
